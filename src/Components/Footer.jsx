...
const Footer = () => {
  return (
    <div className="w-[100%] text-white bg-gradient-to-b from-green-500 to-white">
      ...
      {/* bottom */}
      <div className="flex flex-col md:flex-row md:justify-between px-10 justify-center items-center py-4 gap-7 pb-[17px] bg-gradient-to-t from-white  to-white/20 text-black">
        <p className="text-[10px] md:text-[8px] tracking-[4px]">
          © 2024 Classy<span className="text-red-500 font-bold">Fit</span> ALL
          RIGHTS RESERVED.
        </p>
        {/* logo Section */}
        <div className="relative  border-white border-2 pl-1  pb-1 pr-5"></div>
