    ...
    <div className="w-[800px] h-[500px] flex shadow-[1px_1px_5px_rgba(0,0,0,0.9)] bg-gradient-to-r from-green-500/50 to-black/60 rounded-4xl relative">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <form onSubmit={handelSubmit}>
          ...
          <div>
            <button
              className="mb-8 mt-5 bg-green-600 text-[18px] text-white border-0 p-1 pr-10 -ml-3 shadow-[1px_1px_5px_rgba(0,0,0,0.9)] font-extrabold"
              type="submit"
            >
              Sign in
            </button>
      ...
      <div className="flex-1 flex items-center justify-center p-2">
        <div className="w-full h-full overflow-hidden rounded-r-4xl">
