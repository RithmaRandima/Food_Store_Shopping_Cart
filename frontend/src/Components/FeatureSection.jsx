...
const FeatureSection = () => {
  ...
  return (
    <>
      {/* desktop */}
      <div className="hidden md:flex relative h-full p-5 px-20 flex-col gap-10 ">
        {/* top */}
        <div className=" flex ">
          <div className="flex-1 flex justify-center items-center text-center">
            ...
            >
              ...
              <p className="text-black text-[19px] font-extralight">
                "We bring you the freshest groceries every day, carefully
                sourced from trusted farms and suppliers. From crisp vegetables
                to daily essentials, we make healthy living simple, convenient,
                and accessible for every home."
              </p>
          ...
          <div className=" flex-1">
            ...
            >
              ...
              <p className="text-black text-center text-[19px] font-extralight">
                ...
                daily needs all in one place. We focus on quality,
                affordability, and convenience to make your grocery shopping
        ...
        <div className=" flex ">
          <div className=" flex-1 flex justify-center items-center text-center">
            ...
            >
              ...
              <p className="underline text-black text-[20px] mt-5">
                LEarn More
              </p>
            </motion.div>
          </div>
      ...
      <div className="md:hidden relative h-full  flex flex-col gap-10 ">
        {/* top */}
        <div className="mb-15">
          {/* header */}
          <div className="text-left ">
            ...
            <h1 className="text-green-500 uppercase text-[50px] tracking-[5px] font-extrabold mb-4">
              Living
            </h1>
          </div>
          <p className="text-left text-black text-[19px] font-extralight">
          ...
          <p className="text-black text-left text-[19px] font-extralight my-2">
            Enjoy quality you can trust, delivered with care to your doorstep—so
            you spend less time shopping and more time living.
          </p>
          <p className="text-black text-left text-[19px] font-extralight">
            We make everyday shopping effortless with reliable delivery and
            handpicked products you can count on.
          </p>

          <p className="underline text-left text-black text-[20px] mt-5">
            Shop Mow
          </p>
        </div>
        {/* middle */}
        <div className=" mb-50">
          ...
          <div className="text-center ">
            ...
            <h1 className="text-purple-500 uppercase text-[40px] tracking-[2px] font-extrabold mb-4">
              Our Store
            </h1>
          </div>
          <p className="text-black text-center text-[19px] font-extralight">
            ...
            and convenience to make your grocery shopping smooth and enjoyable."
          </p>
      ...
      <div className=" flex justify-center items-center text-center">
        ...
        <div className="">
          ...
          <div className="text-right">
            ...
            <h1 className="text-red-400 uppercase text-[50px] tracking-[5px] font-extrabold mb-4">
              Quality
            </h1>
          </div>
          <p className="text-balck text-right text-[19px] font-extralight">
            "We partner with trusted farmers and suppliers to bring you
            high-quality products you can rely on. Every item is carefully
            selected to ensure freshness, nutrition, and value for your everyday
            needs."
          </p>

          <p className="underline text-right text-black text-[20px] mt-5">
            Learn More
          </p>
        </div>
      </div>
